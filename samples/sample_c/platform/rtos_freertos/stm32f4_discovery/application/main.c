...
int main(void)
{
    ...
    /* Create start task */
    xTaskCreate((TaskFunction_t) GduUser_StartTask, "start_task", USER_START_TASK_STACK_SIZE,
                NULL, USER_START_TASK_PRIORITY, (TaskHandle_t *) startTask);

#if 1
    /* Create runIndicate task */
    xTaskCreate((TaskFunction_t) GduUser_MonitorTask, "monitor_task", USER_RUN_INDICATE_TASK_STACK_SIZE,
