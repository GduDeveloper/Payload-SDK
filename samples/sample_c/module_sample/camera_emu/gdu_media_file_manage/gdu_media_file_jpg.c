...
} T_GduJPGTempFilePriv;

/* Private functions declaration ---------------------------------------------*/
static T_GduReturnCode GduMediaFile_CreateTempFilePriv_JPG(const char *srcFilePath, const char *scaleCfgStr,
                                                           T_GduJPGTempFilePriv **pTempFilePrivHandle);
static T_GduReturnCode GduMediaFile_DestroyTempFilePriv_JPG(T_GduJPGTempFilePriv *tempFilePrivHandle);
...
{
    return GduMediaFile_CreateTempFilePriv_JPG(mediaFileHandle->filePath, JPG_THM_SCALE_CFG_STR,
                                               (T_GduJPGTempFilePriv **) &mediaFileHandle->mediaFileThm.privThm);
}

T_GduReturnCode GduMediaFile_GetFileSizeThumbNail_JPG(struct _GduMediaFile *mediaFileHandle, uint32_t *fileSize)
{
    T_GduJPGTempFilePriv *jpgFileThmPriv = (T_GduJPGTempFilePriv *) mediaFileHandle->mediaFileThm.privThm;
...
{
    return GduMediaFile_DestroyTempFilePriv_JPG(mediaFileHandle->mediaFileThm.privThm);
}

T_GduReturnCode GduMediaFile_CreateScreenNail_JPG(struct _GduMediaFile *mediaFileHandle)
{
    return GduMediaFile_CreateTempFilePriv_JPG(mediaFileHandle->filePath, JPG_SCR_SCALE_CFG_STR,
                                               (T_GduJPGTempFilePriv **) &mediaFileHandle->mediaFileScr.privScr);
}

T_GduReturnCode GduMediaFile_GetFileSizeScreenNail_JPG(struct _GduMediaFile *mediaFileHandle, uint32_t *fileSize)
{
    T_GduJPGTempFilePriv *jpgFileScrPriv = (T_GduJPGTempFilePriv *) mediaFileHandle->mediaFileScr.privScr;
...
{
    return GduMediaFile_DestroyTempFilePriv_JPG(mediaFileHandle->mediaFileScr.privScr);
}
                                                           ...
                                                           T_GduJPGTempFilePriv **pTempFilePrivHandle)
{
    ...
    T_GduJPGTempFilePriv *jpgTempFilePriv;
    ...
    *pTempFilePrivHandle = osalHandler->Malloc(sizeof(T_GduJPGTempFilePriv));
