/**
 ********************************************************************
 * @file    gdu_time_sync.h
 * @brief   This is the header file for "gdu_time_sync.c", defining the structure and
...
#ifndef GDU_TIME_SYNC_H
#define GDU_TIME_SYNC_H
 ...
 */
typedef T_GduReturnCode (*GduGetNewestPpsTriggerLocalTimeUsCallback)(uint64_t *localTimeUs);
 ...
 * is detected.
 * @details GDU uses the timestamp information to synchronise time of local time system and RTK navigation and
 * positioning system.
 ...
 * @note Before calling the interface, users must call GduTimeSync_RegGetNewestPpsTriggerTimeCallback() to register
