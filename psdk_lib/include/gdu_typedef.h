...
typedef enum {
    ...
    GDU_AIRCRAFT_TYPE_S28SD= 26,
    GDU_AIRCRAFT_TYPE_S280S= 27,
    GDU_AIRCRAFT_TYPE_S280H= 28,
    GDU_AIRCRAFT_TYPE_P300= 29,
    GDU_AIRCRAFT_TYPE_P200= 30,
    GDU_AIRCRAFT_TYPE_P220= 31,
    GDU_AIRCRAFT_TYPE_P22H= 32,
    GDU_AIRCRAFT_TYPE_P22P= 33,
    GDU_AIRCRAFT_TYPE_P20T= 34,
    GDU_AIRCRAFT_TYPE_P22T= 35,
    GDU_AIRCRAFT_TYPE_P22S= 36,
} E_GduAircraftType;
/**
 * @brief Camera type.
 */
